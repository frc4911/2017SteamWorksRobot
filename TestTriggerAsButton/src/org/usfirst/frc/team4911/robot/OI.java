...
public class OI {
	...
	public OI() {
		//drive = new C_TriggerWhenPressed(new C_MoveDriveTrain(), stick, true);
		Command driveLeft = new C_MoveDriveTrain();
		drive = new C_TriggerWhileHeld(driveLeft, gamepad, true);
		leftBumper.whenPressed(new C_StopCommand(driveLeft));
	}
	//// CREATING BUTTONS
