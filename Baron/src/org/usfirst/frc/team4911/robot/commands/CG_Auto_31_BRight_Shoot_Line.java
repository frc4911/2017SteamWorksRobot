 ...
 *
 */
public class CG_Auto_31_BRight_Shoot_Line extends CommandGroup {

    public CG_Auto_31_BRight_Shoot_Line() {
    	
        // spin up flywheel
        addParallel(new C_SpinFlywheel(8000)); // speed up pid due to gap from boiler
