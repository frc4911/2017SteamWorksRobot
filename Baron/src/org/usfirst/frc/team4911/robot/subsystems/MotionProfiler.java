...
public class MotionProfiler {
	...
	double kf, kp, kd, ki;
	boolean flipEncoder, flipMotor;
	String encoderName;
	double periodicUpdate;
	
	public MotionProfiler(CANTalon talon, double [][]newPoints, double kf, double kp, double kd, double ki, String encoderName, boolean flipEncoder, boolean flipMotor){
		this.talon = talon;
		this.kf = kf;
		this.kp = kp;
		this.kd = kd;
	...
	public void enterMPMode() {
		...
		talon.setD(kd);
		talon.setI(ki);
		talon.reverseSensor(flipEncoder);
		talon.reverseOutput(flipMotor);
